...
import { Button,Text, Icon, TopNavigation, TopNavigationAction } from '@ui-kitten/components';
...
class Alarms_occ extends Component {
    ...
    //function to change the boolean value to display the modal
    handleVisibility(bool) {
        this.setState({ visibility: bool })
    }
    //Method to format the data fetch to know the occurence of trigger
    dataProcessing = (data) => {
        let category = []
        let reformatedData = []
